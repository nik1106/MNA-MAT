    ...
    for i=1:length(Name)
        switch(Name{i}(1))
            case{'R'}
                ...
                num_R=num_R+1;
                %If first run, and first resistor parsed - obtain distribution type and associated properties from user
                if((i_i==1)&&(num_R==1)) 
            ...
            case{'C'}
                ...
                Element(num_Elements).Value=str2double(value{i});
                num_C=num_C+1;
                %If first run, and first capacitor parsed - obtain distribution type and associated properties from user
                if((i_i==1)&&(num_C==1))
            ...
            case{'L'}
                ...
                Element(num_Elements).Value=str2double(value{i});
                num_L=num_L+1;
                %If first run, and first inductor parsed - obtain distribution type and associated properties from user
                if((i_i==1)&&(num_L==1)) 
